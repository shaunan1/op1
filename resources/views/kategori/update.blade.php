                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('kategori.update', $kategori->ID_kategori) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="Nama_kategori" id="Nama_kategori" value="{{ old('Nama_kategori', $kategori->Nama_kategori) }}" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300" placeholder="Masukkan nama kategori">
                            @error('Nama_kategori')
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="Deskripsi" id="Deskripsi" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300" placeholder="Masukkan deskripsi kategori">{{ old('Deskripsi', $kategori->Deskripsi) }}</textarea>
                        </div>

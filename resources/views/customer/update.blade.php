                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('customer.update', $customer->ID_customer) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="Nama_customer" id="Nama_customer" value="{{ old('Nama_customer', $customer->Nama_customer) }}" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300" placeholder="Masukkan nama pelanggan">
                            @error('Nama_customer')
